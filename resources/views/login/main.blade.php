        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5">
                    ...
                    <span class="text-white text-lg ml-3">
                        Alan<span class="font-medium">TI</span>
                    </span>
                </a>
                <div class="my-auto">
                    <img alt="Tinker Tailwind HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="{{ asset('dist/images/login/login-v2.svg') }}">
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">{{ __('A few more clicks to') }} <br> {{ __('sign in to your account.') }}</div>
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-gray-500">{{ __('Manage all your orders in one place') }}</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div class="intro-x mt-2 text-gray-500 xl:hidden text-center">{{ __('A few more clicks to sign in to your account. Manage all your e-commerce accounts in one place') }}</div>
                    ...
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        <button id="btn-login" class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">{{ __('Login') }}</button>
                        <button class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">{{ __('Sign up') }}</button>
                    </div>
                    <div class="intro-x mt-10 xl:mt-24 text-gray-700 dark:text-gray-600 text-center xl:text-left">
                        {{ __('By signin up, you agree to our') }} <br> <a class="text-theme-1 dark:text-theme-10" href="">{{ __('Terms and Conditions') }}</a> & <a class="text-theme-1 dark:text-theme-10" href="">{{ __('Privacy Policy') }}</a>
                    </div>
                </div>
            </div>
            <!-- END: Login Form -->
