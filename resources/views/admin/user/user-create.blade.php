...
@section('subhead')
    <title>{{ __('Create User')}} - . {{ env('APP_NAME') }}</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">{{ __('Create User')}}</h2>
    </div>
                    ...
                    <div class="preview">
                        ...
                        <form class="validate-form">
                            <div class="input-form">
                                ...
                                <input  id="validation-form-1" type="text" name="name" class="form-control grid-cols-6" placeholder="John Legend" minlength="2" required>
                            </div>
