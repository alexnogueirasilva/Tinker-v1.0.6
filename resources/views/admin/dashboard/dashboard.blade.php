            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">{{ __('General Report') }}</h2>
                        <a href="" class="ml-auto flex items-center text-theme-30 dark:text-theme-25">
                            <i data-feather="refresh-ccw" class="w-4 h-4 mr-3"></i> {{ __('Reload Data') }}
                        </a>
                    </div>
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-gray-600 mt-1">{{ __('Requests Fulfilled') }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-gray-600 mt-1">{{ __('New Orders') }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-gray-600 mt-1">{{ __('Total Items Served') }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-gray-600 mt-1">{{ __('Total Customers') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-span-12 lg:col-span-6 mt-8">
                    <div class="intro-y block sm:flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">{{ __('Sales Report') }}</h2>
                        ...
                        <div class="flex flex-col xl:flex-row xl:items-center">
                            <div class="flex">
                                <div>
                                    ...
                                    <div class="mt-0.5 text-gray-600 dark:text-gray-600">{{ __('This Month') }}</div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-0.5 text-gray-600 dark:text-gray-600">{{ __('Last Month') }}</div>
                                </div>
                            </div>
                            <div class="dropdown xl:ml-auto mt-5 xl:mt-0">
                                <button class="dropdown-toggle btn btn-outline-secondary font-normal" aria-expanded="false">
                                    {{ __('Filter by Category') }} <i data-feather="chevron-down" class="w-4 h-4 ml-2"></i>
                                </button>
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-3 mt-8">
                    <div class="intro-y flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">{{ __('Weekly Top Seller') }}</h2>
                        <a href="" class="ml-auto text-theme-30 dark:text-theme-25 truncate">{{ __('Show More') }}</a>
                    </div>
